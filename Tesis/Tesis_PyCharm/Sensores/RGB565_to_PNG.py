...
def generate_image_from_file(file_path, width, height):
...
file_path = "../../Sensores/CircuitPython/Camera_pics/Binary_pic.txt"
...
image = generate_image_from_file(file_path, width, height)
